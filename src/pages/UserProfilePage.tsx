...
const mockCourseProgress: Array<Course & { progress: number; last_accessed: string; completed_modules: number; total_modules: number }> = [
  {
    ...
    author_id: 'author-1',
    author: { id: 'author-1', email: 'instructor@winbro.com', full_name: 'Safety Expert', role: 'trainer' as const, is_verified: true, is_active: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
    status: 'published',
  ...
  },
  {
    ...
    author_id: 'author-2',
    author: { id: 'author-2', email: 'instructor2@winbro.com', full_name: 'Machine Expert', role: 'trainer' as const, is_verified: true, is_active: true, created_at: '2024-01-01', updated_at: '2024-01-01' },
    status: 'published',
    customer_assignments: ['org-1'],
    modules: [],
    settings: {
